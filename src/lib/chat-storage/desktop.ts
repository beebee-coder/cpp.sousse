 ...
 * Utilise le stockage persistant de la WebView Tauri avec écriture
 * atomique par clé temporaire et recovery sur corruption.
 */
...
export const desktopStorage: ChatStorage = {
  async saveHistory(messages: ChatMessage[], userId?: string, conversationId?: string) {
    ...
    try {
      ...
      console.warn('[CHAT_STORAGE] Desktop saveHistory failed:', e);
    }
  },
